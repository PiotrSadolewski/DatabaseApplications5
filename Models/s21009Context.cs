...
{
    public partial class s21009Context : DbContext
    {
        public s21009Context()
        {
        }

        public s21009Context(DbContextOptions<s21009Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=db-mssql16.pjwstk.edu.pl;Initial Catalog=s21009;Integrated Security=True");
            }
        }
